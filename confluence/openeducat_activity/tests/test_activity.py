...
class TestStudentMigrateWizard(TestActivityCommon):
    ...
    def test_case_1_student_migrate_wizard(self):
        student_migrate = self.op_student_migrate_wizard.create({
            'level_from_id': self.env.ref('openeducat_core.op_level_2').id,
            'level_to_id': self.env.ref('openeducat_core.op_level_3').id,
        ...
        student_migrate1 = self.op_student_migrate_wizard.create({
            'level_from_id': self.env.ref('openeducat_core.op_level_3').id,
            'level_to_id': self.env.ref('openeducat_core.op_level_2').id,
        ...
        student_migrate1.onchange_level_id()
